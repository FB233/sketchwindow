...
public:
    ...
    {
        ParameterEstimationDialog->setWindowTitle(QApplication::translate("ParameterEstimationDialog", "ParameterEstimationDialog", Q_NULLPTR));
        pushButtonCancel->setText(QApplication::translate("ParameterEstimationDialog", "Cancel", Q_NULLPTR));
        pushButtonOK->setText(QApplication::translate("ParameterEstimationDialog", "OK", Q_NULLPTR));
        label_12->setText(QApplication::translate("ParameterEstimationDialog", "Classification directory:", Q_NULLPTR));
        label_15->setText(QApplication::translate("ParameterEstimationDialog", "Test data directory:", Q_NULLPTR));
        pushButtonTestDataDirectory->setText(QApplication::translate("ParameterEstimationDialog", "...", Q_NULLPTR));
        label_16->setText(QApplication::translate("ParameterEstimationDialog", "Regression directory:", Q_NULLPTR));
        pushButtonClassificationDirectory->setText(QApplication::translate("ParameterEstimationDialog", "...", Q_NULLPTR));
        pushButtonRegressionDirectory->setText(QApplication::translate("ParameterEstimationDialog", "...", Q_NULLPTR));
        label_17->setText(QApplication::translate("ParameterEstimationDialog", "Output directory:", Q_NULLPTR));
        pushButtonOutputDirectory->setText(QApplication::translate("ParameterEstimationDialog", "...", Q_NULLPTR));
        label_22->setText(QApplication::translate("ParameterEstimationDialog", "Object type:", Q_NULLPTR));
        label_18->setText(QApplication::translate("ParameterEstimationDialog", "CGA directory:", Q_NULLPTR));
        pushButtonCGADirectory->setText(QApplication::translate("ParameterEstimationDialog", "...", Q_NULLPTR));
    } // retranslateUi
