...
public:
    ...
    {
        ImageGenerationDialog->setWindowTitle(QApplication::translate("ImageGenerationDialog", "ImageGenerationDialog", Q_NULLPTR));
        pushButtonOK->setText(QApplication::translate("ImageGenerationDialog", "OK", Q_NULLPTR));
        pushButtonCancel->setText(QApplication::translate("ImageGenerationDialog", "Cancel", Q_NULLPTR));
        label->setText(QApplication::translate("ImageGenerationDialog", "Object type:", Q_NULLPTR));
        label_2->setText(QApplication::translate("ImageGenerationDialog", "CGA directory:", Q_NULLPTR));
        pushButtonCGADirectory->setText(QApplication::translate("ImageGenerationDialog", "...", Q_NULLPTR));
        label_3->setText(QApplication::translate("ImageGenerationDialog", "Output directory:", Q_NULLPTR));
        pushButtonOutputDirectory->setText(QApplication::translate("ImageGenerationDialog", "...", Q_NULLPTR));
        label_4->setText(QApplication::translate("ImageGenerationDialog", "Image size:", Q_NULLPTR));
        checkBoxGrayscale->setText(QApplication::translate("ImageGenerationDialog", "Grayscale", Q_NULLPTR));
        label_5->setText(QApplication::translate("ImageGenerationDialog", "Color:", Q_NULLPTR));
        label_6->setText(QApplication::translate("ImageGenerationDialog", "px", Q_NULLPTR));
        label_7->setText(QApplication::translate("ImageGenerationDialog", "Edge displacement:", Q_NULLPTR));
        label_8->setText(QApplication::translate("ImageGenerationDialog", "px", Q_NULLPTR));
        checkBoxRemoveInvalid->setText(QApplication::translate("ImageGenerationDialog", "Remove invalid images", Q_NULLPTR));
        checkBoxSketchyLine->setText(QApplication::translate("ImageGenerationDialog", "Use sketchy lines", Q_NULLPTR));
    } // retranslateUi
